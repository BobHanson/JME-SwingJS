...
public class JMEevent {
	...
	public JMEevent reset() {
		...
		this.bondAtoms = JMEUtil.createArray(2);
		this.bondAtoms[0] = 0;
		this.bondAtoms[1] = 0;

		atomE = 0;
		bondE = 0;
		this.bondAtomsE = JMEUtil.createArray(2);
		this.bondAtomsE[0] = 0;
		this.bondAtomsE[1] = 0;
  ...
  private native void consoleLog(String msg) /*-{
	...
	public JMEevent setAtomAndMol(JMEmolList moleculeParts, int atom, int mol) {
		...
		if (eAtom != null) {
			...
			this.atomBackgroundColorIndex = atomObj.getMark();
	...
	public JMEevent setAtomAndBondAndMol(JMEmolList moleculeParts,  int atom, int bond,
			int mol) {
